...
sourcefilekey1 = {
    ...
    "STX_DATE": [None, 5, 1, "STX_DATE", "STX_DATE", ""],
    "STX_GENERAL_CUSTOM_SKU": [None, 6, 1, "STX_GENERAL_CUSTOM_SKU", "STX_GENERAL_CUSTOM_SKU", ""],
    "STX_WARRANTY_END_DATE": [None, 7, 1, "STX_WARRANTY_END_DATE", "STX_WARRANTY_END_DATE", ""],
    "STX_CURRENCY": [None, 8, 1, "STX_CURRENCY", "STX_CURRENCY", ""],
    "XITOR_CLASS_ID": [None, 9, 1, "XITOR_CLASS_ID", "XITOR_CLASS_ID", ""],
    "STX_STATUS": [None, 10, 1, "STX_STATUS", "STX_STATUS", ""],
    "STX_FINANCIAL_FEES": [None, 11, 1, "STX_FINANCIAL_FEES", "STX_FINANCIAL_FEES", ""],
    "STX_MARKETPLACE_TX_ID": [None, 12, 1, "STX_MARKETPLACE_TX_ID", "STX_MARKETPLACE_TX_ID", ""],
    "STX_SELL_ID_NUM": [None, 13, 1, "STX_SELL_ID_NUM", "STX_SELL_ID_NUM", ""],
    "STX_TOTAL": [None, 14, 1, "STX_TOTAL", "STX_TOTAL", ""],
    "SALETX_SUBTOTAL2": [None, 15, 1, "SALETX_SUBTOTAL2", "SALETX_SUBTOTAL2", ""],
    "STX_SELL_ACCT_CHAN": [None, 16, 1, "STX_SELL_ACCT_CHAN", "STX_SELL_ACCT_CHAN", ""],
    "STX_SELLING_ACCOUNT": [None, 17, 1, "STX_SELLING_ACCOUNT", "STX_SELLING_ACCOUNT", ""],
    "STX_PAY_ACCOUNT": [None, 18, 1, "STX_PAY_ACCOUNT", "STX_PAY_ACCOUNT", ""],
    "STX_DESC": [None, 19, 1, "STX_DESC", "STX_DESC", ""],
    "STX_IMPORT_ID": [None, 20, 1, "STX_IMPORT_ID", "STX_IMPORT_ID", ""],
    "STX_GEN_BUYER_NOTES": [None, 21, 1, "STX_GEN_BUYER_NOTES", "STX_GEN_BUYER_NOTES", ""],
    "STX_ID_TRACKING_SECONDARY": [None, 22, 1, "STX_ID_TRACKING_SECONDARY", "STX_ID_TRACKING_SECONDARY", ""],
    "STX_FINANCIAL_TX_ID": [None, 23, 1, "STX_FINANCIAL_TX_ID", "STX_FINANCIAL_TX_ID", ""],
    "STX_SHIPPING_NAME": [None, 24, 1, "STX_SHIPPING_NAME", "STX_SHIPPING_NAME", ""],
    "STX_SHIPPING_ADDRESS1": [None, 25, 1, "STX_SHIPPING_ADDRESS1", "STX_SHIPPING_ADDRESS1", ""],
    "STX_SHIPPING_ADDRESS2": [None, 26, 1, "STX_SHIPPING_ADDRESS2", "STX_SHIPPING_ADDRESS2", ""],
    "STX_SHIPPING_CITY": [None, 27, 1, "STX_SHIPPING_CITY", "STX_SHIPPING_CITY", ""],
    "STX_SHIPPING_PROVINCE": [None, 28, 1, "STX_SHIPPING_PROVINCE", "STX_SHIPPING_PROVINCE", ""],
    "STX_SHIPPING_ZIP": [None, 29, 1, "STX_SHIPPING_ZIP", "STX_SHIPPING_ZIP", ""],
    "STX_SHIPPING_COUNTRY": [None, 30, 1, "STX_SHIPPING_COUNTRY", "STX_SHIPPING_COUNTRY", ""],
    "STX_SHIPPING_PHONE": [None, 31, 1, "STX_SHIPPING_PHONE", "STX_SHIPPING_PHONE", ""],
    "STX_EMAIL": [None, 32, 1, "STX_EMAIL", "STX_EMAIL", ""],
    "STX_PAY_FROM_MRKT": [None, 33, 1, "STX_PAY_FROM_MRKT", "STX_PAY_FROM_MRKT", ""],
    "STX_PERC_WITHHELD": [None, 34, 1, "STX_PERC_WITHHELD", "STX_PERC_WITHHELD", ""],
    "STX_SELL_RECOVERY": [None, 35, 1, "STX_SELL_RECOVERY", "STX_SELL_RECOVERY", ""],
    "STX_CALC_ITEM_PROFIT": [None, 36, 1, "STX_CALC_ITEM_PROFIT", "STX_CALC_ITEM_PROFIT", ""],
    "SALETX__NET_MARGIN_2": [None, 37, 1, "SALETX__NET_MARGIN_2", "SALETX__NET_MARGIN_2", ""],
    "STX_LINE_ITEM_ROI": [None, 38, 1, "STX_LINE_ITEM_ROI", "STX_LINE_ITEM_ROI", ""],
    "STX_ITEM_QUANTITY": [None, 39, 1, "STX_ITEM_QUANTITY", "STX_ITEM_QUANTITY", ""],
    "STX_SHIPPING_COST": [None, 40, 4, "STX_SHIPPING_COST", "STX_SHIPPING_COST", ""],
    "STX_SHIPPING_COST_COUNT": [None, 41, 1, "STX_SHIPPING_COST_COUNT", "STX_SHIPPING_COST_COUNT", ""],
    "STX_INITIAL_COST": [None, 42, 4, "STX_INITIAL_COST", "STX_INITIAL_COST", ""],
    "STX_INITIAL_COST_COUNT": [None, 43, 1, "STX_INITIAL_COST_COUNT", "STX_INITIAL_COST_COUNT", ""],
    "STX_COMMISSION_FEES": [None, 44, 4, "STX_COMMISSION_FEES", "STX_COMMISSION_FEES", ""],
    "STX_COMMISSION_FEES_COUNT": [None, 45, 1, "STX_COMMISSION_FEES_COUNT", "STX_COMMISSION_FEES_COUNT", ""],
    "STX_ADPROMO_COSTS": [None, 46, 1, "STX_ADPROMO_COSTS", "STX_ADPROMO_COSTS", ""],
    "SALETX___OF_LINES": [None, 47, 1, "SALETX___OF_LINES", "SALETX___OF_LINES", ""],
    "SALETX__SHIPPING_CHARGES": [None, 48, 1, "SALETX__SHIPPING_CHARGES", "SALETX__SHIPPING_CHARGES", ""],
    "SALETX__MISC_CHARGES": [None, 49, 1, "SALETX__MISC_CHARGES", "SALETX__MISC_CHARGES", ""],
    "STX_TAXES2": [None, 50, 1, "STX_TAXES2", "STX_TAXES2", ""],
    "SALETX__SHIPPING_CHARGES__TAXE": [None, 51, 1, "SALETX__SHIPPING_CHARGES__TAXE", "SALETX__SHIPPING_CHARGES__TAXE",
                                       ""],
    "SALETX__MISC_CHARGES__TAXES": [None, 52, 1, "SALETX__MISC_CHARGES__TAXES", "SALETX__MISC_CHARGES__TAXES", ""],
    "STX_CREATED_AT": [None, 53, 1, "STX_CREATED_AT", "STX_CREATED_AT", ""],
    "STX_UPDATED_AT": [None, 54, 1, "STX_UPDATED_AT", "STX_UPDATED_AT", ""],
...
def sourcefilekey_processing(filerow):
    ...
    for temprow3 in newfilerows:
        ...
        if LOCAL_CONSOLE_OUTPUT1:
            ...
            print("temprow3[prodcostloc]:" + str(temprow3[prodcostloc]))git
